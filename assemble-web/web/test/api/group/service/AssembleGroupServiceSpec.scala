...
class AssembleGroupServiceSpec extends WordSpecLike
  ...
  "The AssembleGroupService" must {
    ...
    "create groups" in {
      ...
      val request = CreateGroupRequest("test-group-name", "test-group-category", CreateGroupDetails(2))
    ...
    "list groups" in {
      ...
      Await.result(classUnderTest.createGroup(user, CreateGroupRequest("test-group-name-1", "test-group-category1", CreateGroupDetails(2))), 1 seconds)
      Await.result(classUnderTest.createGroup(user, CreateGroupRequest("test-group-name-2", "test-group-category2", CreateGroupDetails(2))), 1 seconds)
      Await.result(classUnderTest.createGroup(user, CreateGroupRequest("test-group-name-3", "test-group-category3", CreateGroupDetails(2))), 1 seconds)
      Await.result(classUnderTest.createGroup(user, CreateGroupRequest("test-group-name-4", "test-group-category4", CreateGroupDetails(2))), 1 seconds)
